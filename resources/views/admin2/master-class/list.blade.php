                            ...
                            <tbody>
                                @forelse($video as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->link }}</td>
                                        <td>
                                            <a href="{{ route('admin.Masterclass.edit', $data->id) }}" title="@lang('Edit')"
    ...
    <div id="rejectModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.Masterclass.delete') }}" method="POST">
                    @csrf
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.Masterclass.add') }}" class="btn btn-sm btn--primary">
        @lang('Add Master Class')</a>
@endpush

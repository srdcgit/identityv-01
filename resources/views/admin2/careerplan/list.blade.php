                            ...
                            <tbody>
                                @forelse($image as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->link }}</td>
                                        <td>
                                            <a href="{{ route('admin.careerplan.edit', $data->id) }}"
    ...
    <div id="rejectModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.careerplan.delete') }}" method="POST">
                    @csrf
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.careerplan.add') }}" class="btn btn-sm btn--primary">
        @lang('Add Career Plan')</a>
@endpush
@push('script')
    <script>

                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('2nd Category Name')</th>
                                    <th>@lang('Title')</th>
                                    <th>@lang('Institutions')</th>
                                    <th>@lang('File')</th>
                            ...
                            <tbody>
                                @forelse($subcategories as $subcategory)
                                    <tr>
                                        <td>{{ @$subcategory->userCategory->title ?? 'N/A' }}</td>
                                        <td>{{ @$subcategory->getCategory->name ?? 'N/A' }}</td>
                                        <td>{{ $subcategory->title }}</td>
                                        <td>
                                            {!! $subcategory->institutions->isNotEmpty() 
                                                ? $subcategory->institutions->pluck('name')->implode(',<br>') 
                                                : 'N/A' !!}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.subcategory.edit', $subcategory->id) }}"
                                                title="@lang('Edit')" data-id="{{ $subcategory->id }}"
                                                class="btn btn-sm btn--primary ">
                                                <i class="las la-edit"></i>
                                            </a>
                                            <button title="@lang('Remove')" data-id="{{ $subcategory->id }}"
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.subcategory.add') }}" class="btn btn-sm btn--primary ">

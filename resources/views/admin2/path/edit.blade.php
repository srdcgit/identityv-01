                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control" name="stream_id" id="stream" required>
                                        ...
                                        @foreach ($streams as $stream)
                                            <option value="{{ $stream->id }}"
                                                {{ $stream->id == $edit->stream_id ? 'selected' : '' }}>{{ $stream->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pathtype_id" class="form-control" required>
                                        ...
                                        @foreach ($pathtypes as $pathtype)
                                            <option {{ $edit->pathtype_id == $pathtype->id ? 'selected' : '' }}
                                                value=" {{ $pathtype->id }} "> {{ $pathtype->title }} </option>
                                        @endforeach
                                    </select>
                                    @error('pathtype_id')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="anyother" value="{{ $edit->anyother }}"

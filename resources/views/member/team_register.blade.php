...
{{-- @endpush --}}
{{-- @extends('presets.themesFive.layouts.master') --}}
    ...
    <div class="container">
        <div class="row mb-none-30">
            <div class="col-lg-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('member_registration_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="designation" value="{{ old('designation') }}"
                                            class="form-control" placeholder="@lang('Designation')">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="linkedin" value="{{ old('linkedin') }}"
                                            class="form-control" placeholder="@lang('Linkedin')">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="twiter" value="{{ old('twiter') }}"
                                            class="form-control" placeholder="@lang('Twiter')">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="facebook" value="{{ old('facebook') }}"
                                            class="form-control" placeholder="@lang('Facebook')">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" value="{{ old('phone') }}"
                                            class="form-control" placeholder="@lang('Phone Number')">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="permanent_address"
                                            ...
                                            placeholder="@lang('Permanent Address')">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="current_address"
                                            value="{{ old('current_address') }}" class="form-control"
                                            placeholder="@lang('Current Address')">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="type" class="font-weight-bold">@lang('Password')</label>

...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.jobscope.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category_id" id="category" required>
                                        ...
                                        <option value="{{ $category->id }}" {{ ($category->id == $edit->category_id)? 'selected' : '' }}>{{ $category->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subcategory_id" id="subcategory" required>
                                        ...
                                        <option value="{{ $subcategory->id }}" {{ ($subcategory->id == $edit->subcategory_id)? 'selected' : '' }}>{{ $subcategory->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

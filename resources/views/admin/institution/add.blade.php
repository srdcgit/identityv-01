                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="admission_process" value="{{ old('admission_process') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="month" name="tentative_date" value="{{ old('tentative_date') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div style="display: flex; align-items: center;">
                                        <input type="radio" id="govt" name="institute_type" value="0" required
                                            style="margin-right: 5px;">
                                        <label for="govt" style="margin-right: 15px;">Govt.</label>

                                        <input type="radio" id="pvt" name="institute_type" value="1"
                                            style="margin-right: 5px;">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="dist_id" id="getDistrict" required > 

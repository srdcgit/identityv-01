                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="title" class="form-control">
                                        ...
                                        <option value="Schools and Colleges" {{ ($edit->title == "Schools and Colleges")? 'selected' : '' }}>Schools</option>
                                        <option value="Knowledge Partners" {{ ($edit->title == "Knowledge Partners")? 'selected' : '' }}>Knowledge Partners</option>
                                        <option value="CSR Partners" {{ ($edit->title == "CSR Partners")? 'selected' : '' }}>CSR & Corporate</option>
                                    </select>
                                </div>
                            </div>

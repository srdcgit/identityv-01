            ...
            <li class="artist-item active" style="background-image: url('{{ asset('careerplan/' . $data->image) }}');"
                ...
                <div class="section-content">
                    <div class="inner" style="padding-bottom:0px !important">
                        <div class="bio">
                            <h2 style="color: #9f2d26">{{ $data->title }}</h2>
...
<div class="container" style="padding-top:50px;padding-bottom:30px">
        ...
        <div class="row">
            ...
            <div class="top-headings"style="text-align:center">
                <h2 style="color:#9f2d26">Psychometric Assessment</h2>
                <p>Discover the power of our online psychometric assessment, delivering precise results to identify your strengths and guide you towards the most suitable career options, complete with a comprehensive execution plan</p>
            </div>

            <div class="col-md-6 showMobile">
            
                <img loading="lazy" src="assets/images/frontend/about/psm.png" class="img-fluid" alt="Psychometric Assessment" style="height:380px;border-radius:30px">

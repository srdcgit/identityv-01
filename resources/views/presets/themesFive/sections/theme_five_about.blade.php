            ...
            <div class="col-lg-6 col-12">
                ...
                <div class="ed-about__content" style="margin-top:30px;">
                    <div class="title mt-3 mt-lg-0">
                        <h4 style="color:#9f2d26">{{ __(@$about->data_values->heading) }}</h4>
                    </div>
...
<section class="ed-about ed-about__page section-gap position-relative"
    style="height:auto; padding-block:40px; background:#f8f6f6;">
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <img class="img" src="{{ getImage(getFilePath('frontend') . '/theme_five_about' . '/' . @$about->data_values->about_image) }}" alt="about-image"
                style="width:80%; height:582px;width:512px; margin:auto;object-fit:fill; display:block;" />
        </div>
        <div class="col-lg-6 pt-3" style="padding-right:30px">
            

            <h1 style="text-transform:unset; width:30vw; line-height:60px;color:#9f2d26">{{ __(@$about->data_values->heading) }}</h1>

            <p style="width:100%; line-height:24px; font-size:14px;" class="mt-4">{{ __(@$about->data_values->short_description) }}</p>

...
<!-- ==================== why choose end ==================== -->
<!-- 
<section class="why-choose py-3 bg-img" data-background="{{ asset($activeTemplateTrue .'images/why-choose_bg.png') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-12 my-auto">
                <div class="title">
                    <h6>{{__(@$chooseUs->data_values->top_heading)}}</h6>
                    <h4 style="font-size: 22px;">{{__(@$chooseUs->data_values->heading)}}</h4>
            ...
            <div class="col-lg-5 col-12 my-auto  mt-lg-0 mt-5 justify-content-center d-flex">
                <div class="thumb" style="margin-top: 25px;">
                   <img src="{{getImage(getFilePath('frontend').'/theme_five_choose_us'.'/'.@$chooseUs->data_values->choose_image)}}" alt="@lang('image')" style="height: 30rem;">

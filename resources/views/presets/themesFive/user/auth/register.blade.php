...
@section('content')
    ...
    <section class="register-section" style="height:100%;">
        ...
        <div class="row align-items-stretch" style="height:100%;">
            <div class="col-lg-6" style="padding-inline:7vw;">
                ...
                <div class="register-left-part">
                    ...
                    <div style="width:100%;border:0.5px solid #ece9e9; margin-block:40px; position:relative;">
                        <span class="sign-email-text">or Sign in with</span>
                    </div>


                    @if ($credentials->google->status == 1 || $credentials->facebook->status == 1 || $credentials->linkedin->status == 1)
                        <div class="social-media-login-btns d-flex justify-content-center align-items-center gap-3"
                            style="margin-bottom:20px;">

                            <div class="google-login d-flex flex-column align-items-center justify-content-center gap-2">
                                @if ($credentials->google->status == 1)
                                    <button class="google-logo-btn">
                                        <a href="{{ route('user.social.login', 'google') }}">
                            ...
                            <div
                                class="facebook-login1 d-flex flex-column align-items-center justify-content-center gap-2">
                                @if ($credentials->facebook->status == 1)
                                    <button class="google-logo-btn facebook-logo-btn">
                                        <a href="{{ route('user.social.login', 'facebook') }}"></a>
                                        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                            </g>
            ...
            <div class="col-lg-6 register-right-part-container" style="background:var(--template-color);">

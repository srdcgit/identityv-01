...
<style>
    ...
    .nav-pills .nav-link:hover {
        background-color: #9f2d26 !important;
        color: #fff !important;
    }
        ...
        <div class="scroll-container">
            <div class="container">
                <div class="row pt-4 pb-4" style="background-color: var(--template-color); border-radius:8px; color:#fff">
                    <div class="col-md-8">
                        <div class="summary">
                            <h3 style="color: #bab9b9"> {{ $viewSubcategory->title }} </h3>
                                ...
                                @foreach ($job_scopes as $job_scope)
                                    <div class="mb-2">
                                       <strong class="text-dark" style="font-size: 14px; ">
                                        <i class="fas fa-solid fa-circle text-warning" style="margin-right: 8px;font-size: 10px; "></i>{{ $job_scope->name }}
                                        </strong>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <section id="salary-range" class="mt-5">
                            ...
                            <div class="row">
                                @foreach ($salary_range as $salary)
                                    <div class="mb-2">
                                        <strong class="text-dark" style="font-size: 14px;">
                                            <i class="fas fa-solid fa-circle text-warning" style="margin-right: 8px;font-size: 10px; "></i> {{ $salary->salary }}
                                        </strong>
                                    </div>
                                @endforeach
                            </div>

    ...
    <div class="body-wrapper">
        <div class="container mt-5 mb-5">
            ...
            <div class="row">
                ...
                @if ($directSubcategories->isNotEmpty())
                    <div class="col-12 mt-4">
                        <h5>Sub Categories</h5>
                    </div>
                    @foreach ($directSubcategories as $subcat)
                        <div class="col-lg-3 col-md-6 mt-3">
                            <div class="card category-card position-relative text-center"
                                style="height:260px; overflow:hidden; border-radius:20px">
                                <a href="{{ route('user.viewSubcategory', $subcat->id) }}">
                                    <div class="mt-3">
                                        <img src="{{ asset('subcategory/' . $subcat->file) }}" class="category-image"
                                            style="height: 180px; width:260px">
                                    </div>
                                    <div class="card-body">
                                        <h6>{{ $subcat->title }}</h6>

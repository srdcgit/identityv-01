...
header.latest-header .header-right .navbar-nav.pwr-dash-icon > li{border:0px;padding:0px 0px;border-radius:0px}
                        ...
                        {{-- <div class="product-slider">
                            @foreach (App\Models\Bannerslider::all() as $index => $slider)
                                <h1>
                                    {{ $slider->title }} <br>
                                    <p
                                        style="font-size:28px;margin-top:20px;text-align:center;font-family: 'Poppins';color: #9f2d26;">
                        ...
                        <div class="product-slider">
                            @foreach (App\Models\Bannerslider::all() as $index => $slider)
                                <h1 style="text-align: left;">
                                    ...
                                    <br>
                                    <p
                                        style="font-size:28px;margin-top:20px;text-align:left;font-family: 'Poppins', cursive;color: #9f2d26;">
                                        {{ $slider->description }}
                                    </p>
                                </h1>
                            @endforeach

...
header.latest-header .header-right .navbar-nav.pwr-dash-icon > li{border:3px solid #9f2d26;padding:3px 15px;border-radius:10px}
header.latest-header .header-right .navbar-nav.pwr-dash-icon > li:first-child{margin-right:0;padding-right:10px;}
...
header.latest-header .dropdown-menu>li>a:hover, header.latest-header .dropdown-menu>li>a:focus{background-color:#ac2626;color:#fff;background-image:none;border-radius:0px!important}
...
<div class="side-icon-bar">
    ...
    <a id="whatsappLink" href="https://wa.me/+919776808179?text=Your%20predefined%20message" target="blank"
    ...
    <div class="side-icon-bar-lightbox-content">
        <div id="formContainer" class="form-containerr">
            ...
            <form id="enquiry" method="Post" enctype="multipart/form-data"
                ...
                <div class="field-control-group">
                    <input type="text" class="form-control" placeholder="Email ID" name="email" maxlength="100"
                        required style="margin-bottom:5px">
                </div>
                <div class="field-control-group">
...
<div class="container-fluid topbar px-5 d-none d-lg-block">
    <div class="row gx-0">
        ...
        <div class="col-lg-2 text-center text-lg-end">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="#"><i class="fa-brands fa-x-twitter"></i></i></a>
